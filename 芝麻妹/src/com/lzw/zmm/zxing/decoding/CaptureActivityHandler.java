...
package com.lzw.zmm.zxing.decoding;
...
import com.lzw.zmm.zxing.view.ViewfinderResultPointCallback;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.decode_succeeded:
        ...
        boolean result = activity.handleDecode((Result) message.obj, barcode);//���ؽ��?        /***********************************************************************/
        if(!result){
